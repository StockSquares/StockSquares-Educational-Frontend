...
function RecordedCourseCard() {
    ...
    return (
        <>
            <div className="bg-neutral-200   text-xs font-semibold rounded-sm px-6 py-4 row justify-between">
                {/* المعلومات الأساسية */}
                <div className="w-full md:w-1/2">
                    <div className="mb-5">
                        <div className="w-16">
                            <img className="w-full" src={companyLogo} alt="logo-stock-squares" />
                        </div>
                    </div>
                    <span className="bg-primary text-white px-2 py-1 rounded ">ابدأ بناء مستقبل مالي قوي</span>
            ...
            <div className="flex-y-center justify-between mt-4">
                <div>
                    <h3 className="mb-2 text-base font-semibold">أساسيات الاستثمار والتداول في الأسواق المالية</h3>
                    <ul className="row">
                ...
                <div className="mt-4 flex flex-col justify-center items-center w-full p-1">
                    ...
                    <div className="flex justify-between w-full gap-2 text-center font-bold">
                        <div className="w-1/3 rounded-lg p-2 shadow-md bg-gray-100">إعلان</div>
                        <div className="w-1/3 rounded-lg p-2 shadow-md bg-gray-100">إعلان</div>
                        <div className="w-1/3 rounded-lg p-2 shadow-md bg-gray-100">إعلان</div>
                    </div>
                </div>
