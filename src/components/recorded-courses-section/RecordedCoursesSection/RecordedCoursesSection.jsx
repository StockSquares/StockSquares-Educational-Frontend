...
function VideoCard({ videoTitle, instructor, duration, imageUrl, instructorImage, progress = 0 }) {
    ...
    return (
        ...
        >
            <div className="relative rounded-lg overflow-hidden h-36 md:h-48">
                ...
                <div className={`absolute inset-0 flex items-center justify-center bg-black transition-opacity duration-300 ${isHovered ? 'bg-opacity-60' : 'bg-opacity-40'}`}>
                    <motion.button 
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-3">
                            <button 
                                ...
                                className={`transition-colors duration-300 ${isLiked ? 'text-red-500' : 'text-gray-400'}`}
                            >
                                <FontAwesomeIcon icon={faHeart} />
                            </button>
                            <button 
                                onClick={() => setIsSaved(!isSaved)}
                                className={`transition-colors duration-300 ${isSaved ? 'text-green-500' : 'text-gray-400'}`}
                            >
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-3xl font-bold text-gray-800">أساسيات تطوير الأعمال</h1>
            ...
            <div className="flex items-center justify-between mt-8 mb-4">
                <h2 className="text-2xl font-bold text-gray-800">استكشف المزيد من الفيديوهات</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">أكمل من حيث توقفت</h2>
