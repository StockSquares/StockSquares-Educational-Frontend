  ...
  return (
    ...
    <footer className="bg-darkgray dark:bg-black text-white/90">
      <div className="px-4 py-2">
        ...
        {/* 1. الحاوية الرئيسية: تقسّم إلى عمود واحد في الجوال وعمودين متساويين في الشاشات الأكبر (sm:grid-cols-2) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 py-10 gap-10">

          {/* ⬅️ العمود الأول (50%): يحتوي على جميع الروابط ومواقع التواصل الاجتماعي */}
          {/* ملاحظة: دمجنا محتويات الـ grid المتداخلة هنا لتبسيط الهيكل */}
          <div className="flex flex-col justify-between px-3">

            {/* صف الروابط (logo, ourServices, contactUs) */}
            <div className="w-full flex justify-between px-2 flex-wrap">

              {/* 1. قسم الشعار والروابط */}
              <div className="w-1/3 min-w-[150px]">
                <h3 className="text-base font-bold mb-3">{t("logo")}</h3>
                <ul className="text-sm">
                  <li className="pt-2 mb-3">
                    <NavLink className="hover:text-primary-300" to={ROUTES.ABOUTUS}>
                      {t("navbar.aboutUs")}
                    </NavLink>
                  </li>
                  <li className="pt-2 mb-3">
                    <NavLink className="hover:text-primary-300" to={ROUTES.ACTIVITIES}>
                      {t("footer.activities")}
                    </NavLink>
                  </li>
                  <li className="pt-2 mb-3">
                    <NavLink className="hover:text-primary-300" to={ROUTES.PARTNER_APPLICATION}>
                      {t("footer.askAsPartner")}
                    </NavLink>
                  </li>
                </ul>
              ...
              <div className="w-1/3 min-w-[150px]">
                ...
                <ul className="text-sm">
                  <li className="pt-2 mb-3">
                    <NavLink className="hover:text-primary-300" to="training-and-education">
                      {t("navbar.trainingAndEducation")}
                    </NavLink>
                  </li>
                  <li className="pt-2 mb-3">
                    <NavLink className="hover:text-primary-300" to="recorded-courses">
                      {t("navbar.recordedCourses")}
                    </NavLink>
                  </li>
                  <li className="pt-2 mb-3">
                    <NavLink className="hover:text-primary-300" to={ROUTES.CHATAI}>
                      {t("navbar.chatAI")}
                    </NavLink>
                  </li>
                </ul>
              ...
              <div className="w-1/3 min-w-[150px]">
                ...
                <ul className="text-sm">
                  ...
                  <li className="pt-2 mb-3">
                    <NavLink className="hover:text-primary-300" to="opportunities-and-recommendations">
                      {t("footer.contactUs.email")}
                    </NavLink>
                  </li>
                  <li className="pt-2 mb-3">
          ...
          {/* ➡️ العمود الثاني (50%): يحتوي على الخريطة ونموذج الاشتراك */}
          <div className="flex flex-col">

            {/* 1. قسم الخريطة (أصبح حجمه أكبر ليأخذ مساحته في الـ 50% المخصصة له) */}
            <div className="w-full mb-5 flex justify-center h-[200px] sm:h-[250px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9051.862230160345!2d31.348574207638173!3d30.068020383718068!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583f50339ed26f%3A0x62296d6fcc1dc44!2z2LPZitiq2Yog2LPZhtiq2LE!5e0!3m2!1sar!2seg!4v1729089034108!5m2!1sar!2seg"
                width="100%" // أصبح 100% من العمود الثاني
                height="100%"
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                className="rounded-md"
            ...
            {/* 2. قسم الاشتراك في النشرة البريدية */}
            <div className="flex flex-col justify-center text-center mt-5">
              <p className="mb-3 ">{t("footer.subscribe.title")}</p>

              <form className="w-full"> {/* عرض 100% داخل العمود الثاني */}
                <div className="flex gap-3 justify-center items-center">
                  <div className="flex w-[60%] items-center justify-center gap-2">
                    {/* ⚠️ ملاحظة: قمت بحذف أيقونة المظروف المتكررة (موجودة مرتين في الكود الأصلي) */}
                    <FontAwesomeIcon icon={faEnvelope} size="lg" color="gray" className="" />
                    <input placeholder="name@example.com" className="px-3 py-1 w-full text-black"></input>
                  </div>
        ...
        {/* حقوق النشر والروابط السفلية (تبقى كما هي) */}
        <div className="flex items-center mb-5 flex-col">
          <hr className="w-full h-[1px] bg-gray-600 mt-3 mb-3" />
          <div className="flex flex-col sm:flex-row items-center justify-center mt-3 ">
            <small className="tracking-wider text-gray-400 ">جميع الحقوق محفوظه لموقع و منصه ستوك سكويرز 2018 - 2025 </small>
