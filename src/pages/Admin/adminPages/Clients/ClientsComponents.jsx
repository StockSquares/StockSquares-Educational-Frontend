  ...
  return (
    <div className="container mx-auto p-2">
      <div className=" flex flex-col gap-3 items-start justify-center ">
        <h3 className="text-xl mb-4 font-bold dark:text-dark-text ">
          إضافة زبون جديد
        </h3>
        ...
        <Formik
          ...
          onSubmit={(values, { resetForm }) => {
            const newClient = { id: Date.now(), ...values };
...
export function EditClientData() {
  const employeesData = [
    {
      id: 1,
      name: " الاسم",
  ...
  return (
    <div className="w-full p-4">
      <h3 className="text-xl font-bold mb-4">تعديل بيانات الزبون</h3>
