...
function ActivitiesUi({list}) {
  return (
    <div className="mt-7">
      <h1 className="text-2xl font-bold w-[300px] p-2 rounded-l-3xl bg-accent-800">
        {" "}
        الأنشطه والفعاليات{" "}
      </h1>
        ...
        {list.map((card) => (
          <div className="bg-white  h-60 rounded-2xl mt-5 shadow-xl w-[85%] overflow-hidden">
            ...
            <div className="flex justify-between p-2 items-center">
              <span className="text-primary-950 text-md font-bold">
                ١٠٠٠ مشاهدة
              </span>
...
export default React.memo(ActivitiesUi);
