...
import { CreditCard, Calendar, Lock, User, Tag, AlertCircle, Check, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 p-6 md:p-12 rtl" dir="rtl">
      ...
      <div className="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-xl">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-800">إتمام عملية الدفع</h2>
          <p className="text-gray-600 mt-2">أدخل تفاصيل بطاقتك لإتمام عملية الدفع</p>
        </div>
