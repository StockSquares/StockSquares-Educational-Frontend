          ...
          <Tabs.Item active title=" البورصه المصريه ">
            <div className="flex flex-col sm:flex-row items-center gap-7 justify-center">
              {list.map((item) => (
                <div
                  key={item.id}
                  className="flex flex-col gap-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300 w-[300px]"
                >
...
export default React.memo(ChatAiUi);
